 ...
 */
@Mapper
public interface ConferenceThereMapper extends BaseMapper<ConferenceThere> {
    <T> IPage<ConferenceThere> selectPageInfo(Page<T> page, @Param(Constants.WRAPPER) Wrapper<?> wrapper);
    /**
     * id查询
     *
     * @param id tableid
