...
@Mapper
@Repository 
public interface DatamanagementMapper extends BaseMapper<Datamanagement> {
    <T> IPage<Datamanagement> selectPageInfo(Page<T> page, @Param(Constants.WRAPPER) Wrapper<?> wrapper);
    /**
     * id查询
     *
     * @param id tableid
