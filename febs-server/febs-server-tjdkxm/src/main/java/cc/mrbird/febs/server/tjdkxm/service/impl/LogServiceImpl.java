...
import cc.mrbird.febs.server.tjdkxm.mapper.LogMapper;
import cc.mrbird.febs.server.tjdkxm.service.ILogService;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements ILogService {
    ...
    public IPage<Log> findLogs(Log log, QueryRequest request) {
        ...
        if (StringUtils.isNotBlank(log.getUsername())) {
            queryWrapper.lambda().like(Log::getUsername, log.getUsername().toLowerCase());
        }
