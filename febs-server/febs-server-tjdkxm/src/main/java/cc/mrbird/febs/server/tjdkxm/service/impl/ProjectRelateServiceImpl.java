...
import cc.mrbird.febs.server.tjdkxm.mapper.ProjectRelateMapper;
 ...
 */
@Service
public class ProjectRelateServiceImpl extends ServiceImpl<ProjectRelateMapper, ProjectRelate> implements ProjectRelateService {
}
