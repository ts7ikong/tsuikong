package cc.mrbird.febs.server.tjdk.aspect;
...
import cc.mrbird.febs.server.tjdk.service.ILogService;
import cc.mrbird.febs.server.tjdk.service.OperateService;
...
public class ControllerEndpointAspect extends BaseAspectSupport {
    ...
    @Pointcut("execution(* cc.mrbird.febs.server.tjdk.controller.*.*(..)) ")
