...
public interface ValidateCodeService {
     ...
     * @throws ValidateCodeException 验证码异常
     */
    void check(String key, String value) throws FebsException;

    FebsResponse wecreate(HttpServletRequest request, HttpServletResponse response) throws FebsException, IOException;
